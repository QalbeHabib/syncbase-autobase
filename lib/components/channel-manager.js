...
class ChannelManager {
  ...
  async createChannel({ name, type = 'TEXT', topic = '', timestamp = Date.now() }) {
    ...
    const action = this.syncBase.crypto.createSignedAction('@server/create-channel', {
      id: channelId,
      serverId,
      name,
      type,
  ...
  async deleteChannel({ channelId }) {
    ...
    const action = this.syncBase.crypto.createSignedAction('@server/delete-channel', {
      id: channelId,
      serverId,
      timestamp: Date.now()
    })
  ...
  async updateChannel({ channelId, name, topic }) {
    ...
    const action = this.syncBase.crypto.createSignedAction('@server/update-channel', {
      id: channelId,
      serverId,
