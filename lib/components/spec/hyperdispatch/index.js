...
class Router {
  ...
  _checkAll () {
    ...
    assert(this._handler9 !== null, 'Missing handler for "@server/create-invite"')
    assert(this._handler10 !== null, 'Missing handler for "@server/claim-invite"')
    assert(this._handler11 !== null, 'Missing handler for "@server/revoke-invite"')
  }
