...
const encoding0 = {
  ...
  encode(state, m) {
    const flags = (m.avatar ? 1 : 0) | (m.description ? 2 : 0);
...
const encoding1 = {
  ...
  encode(state, m) {
    const flags = (m.topic ? 1 : 0) | (m.position ? 2 : 0);
...
const encoding4 = {
  ...
  encode(state, m) {
    const flags = (m.updatedAt ? 1 : 0) | (m.updatedBy ? 2 : 0);
...
const encoding5 = {
  ...
  encode(state, m) {
    const flags = (m.uses ? 1 : 0) | (m.maxUses ? 2 : 0);
